...
export default class TaskList extends React.Component {
  ...
  render() {
    ...
    if (tasksLoading) {
      ...
      taskList = <FlatList data={orderedTasks} renderItem={this.renderItem} showsVerticalScrollIndicator={false}/>;
    } else {
      taskList = (
        <View style={styles.TaskList_Empty}>
          <Text style={styles.TaskList_EmptyText}>Kegiatan masih kosong</Text>
        </View>
      );
    }
